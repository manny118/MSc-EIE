% This is the main script that uses other functions
close all
clear all

% iterate for every picture on trimap1 and trimap2 
% read input data
input = imread('.\input_training_lowres\GT01.png');
trimap = imread('.\trimap_training_lowres\Trimap1\GT01.png');
gt = imread('.\gt_training_lowres\GT01.png');
